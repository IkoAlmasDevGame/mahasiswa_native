...
if ($_SESSION['user_level'] == "admin") {
    $setting = $koneksi->query("SELECT * FROM tbl_settings WHERE status = '1'");
    $hasil = mysqli_fetch_array($setting);
    extract($hasil);
?>
            ...
            <ul>
                <li class="nav-item dropdown pe-3">
                    ...
                    <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" role="button"
                        ...
                        <?php $baseFile = mysqli_fetch_array($koneksi->query("SELECT * FROM tbl_admin WHERE id = '$_SESSION[admin]'")); ?>
                    ...
                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                        <li class="dropdown-header">
                            ...
                            <div class="form-inline row justify-content-start align-items-start flex-wrap">
                                <div class="form-label col-sm-3 col-md-3">
                                    <label for="" class="form-label label-default">jabatan</label>
                                </div>
                                <div class="col-sm-3 col-md-3">:</div>
                                <div class="col-sm-3 col-md-3">
    ...
    <aside id="sidebar" class="sidebar">
        <ul class="sidebar-nav" id="sidebar-nav">
            <li class="nav-item">
                <a href="?hal=beranda" aria-current="page" class="nav-link collapsed">
            ...
            <!-- Dropdow Sidebar -->
            <li class="nav-item">
                <a href="?hal=siswa" aria-current="page" class="nav-link collapsed">
                    <i class="fa fa-users fa-1x"></i>
                    <span class="fs-4 display-4 text-dark fw-normal">Mahasiwsa</span>
                </a>
            </li>
            <!-- Dropdow Sidebar -->
            <div class="my-1"></div>
            <hr class="dropdown-divider border border-top border-1">
            <li class="nav-item">
                <a href="?hal=edit-profile&admin=<?= $_SESSION['admin'] ?>" title="edit profile admin" aria-current="page"
                    class="nav-link collapsed">
                    <i class="fa fa-user-edit fa-1x has-icon"></i>
                    <span class="fs-4 display-4 text-dark fw-normal">edit profile</span>
                </a>
            </li>
            <div class="my-1"></div>
            <hr class="dropdown-divider border border-top border-1">
            <li class="nav-item">
                <a href="?hal=edit-universitas&id=1" title="edit profile universitas" aria-current="page"
                    class="nav-link collapsed">
                    <i class="fa fa-building fa-1x has-icon"></i>
                    <span class="fs-4 display-4 text-dark fw-normal">edit universitas</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="?hal=logout" onclick="return confirm('Apakah ingin keluar dari website ini ?')" aria-current="page"
                    class="nav-link collapsed">
